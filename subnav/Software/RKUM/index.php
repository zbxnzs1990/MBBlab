...
echo "You will now be redirected to the main Page</b></font></center> <META HTTP-EQUIV = 'Refresh' Content = '3; URL =" . $sitebase ."https://cran.r-project.org/web/packages/RKUM/index.html'> ";
		}else{
...
<!--top-bottom1 end-->     
  ...
  <a href="RKUM.html" class="list-group-item">RKUM</a>
  <a href="index.php" class="list-group-item list-group-item-info">Download</a>
  <a href="#" class="list-group-item">Documentation</a>
  <a href="https://cran.r-project.org/web/packages/RKUM/index.html" target="_blank" class="list-group-item">Publications</a>
...
<h4 class="text-info"><a href="https://cran.r-project.org/web/packages/RKUM/index.html" target="_blank">RKUM</a></h4>
</div>
