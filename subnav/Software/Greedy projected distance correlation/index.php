...
echo "You will now be redirected to the main Page</b></font></center> <META HTTP-EQUIV = 'Refresh' Content = '3; URL =" . $sitebase ."https://sites.google.com/site/jianfang86/gpdc'> ";
		}else{
...
<!--top-bottom1 end-->     
  ...
  <a href="Greedy projected distance correlation.html" class="list-group-item">Greedy projected distance correlation </a>
  <a href="index.php" class="list-group-item list-group-item-info">Download</a>
  <a href="#" class="list-group-item">Documentation</a>
  <a href="http://ieeexplore.ieee.org/document/8194926/" target="_blank" class="list-group-item">Publications</a>
...
<h4 class="text-info"><a href="https://sites.google.com/site/jianfang86/gpdc" target="_blank">Greedy projected distance correlation (GDPC)</a></h4>
</div>
