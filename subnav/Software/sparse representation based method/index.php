...
echo "You will now be redirected to the main Page</b></font></center> <META HTTP-EQUIV = 'Refresh' Content = '3; URL =" . $sitebase ."http://hongbaocao.weebly.com/software-for-download.html'> ";
		}else{
...
<!--top-bottom1 end-->     
  ...
  <a href="sparse representation based method.html" class="list-group-item">sparse representation based method</a>
  <a href="index.php" class="list-group-item list-group-item-info">Download</a>
  <a href="#" class="list-group-item">Documentation</a>
  <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4130811/" target="_blank" class="list-group-item">Publications</a>
...
<h4 class="text-info"><a href="http://hongbaocao.weebly.com/software-for-download.html" target="_blank">Imaging and genomic data integration with sparse representation based method</a></h4>
</div>
