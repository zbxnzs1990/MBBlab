...
echo "You will now be redirected to the main Page</b></font></center> <META HTTP-EQUIV = 'Refresh' Content = '3; URL =" . $sitebase ."http://www.tulane.edu/~wyp/software/Exon_CNV.m'> ";
		}else{
...
<!--top-bottom1 end-->     
  ...
  <a href="sparse model.html" class="list-group-item">sparse model</a>
  <a href="index.php" class="list-group-item list-group-item-info">Download</a>
  <a href="#" class="list-group-item">Documentation</a>
  <a href="https://www.ncbi.nlm.nih.gov/pubmed/26258935" target="_blank" class="list-group-item">Publications</a>
...
<h4 class="text-info"><a href="http://www.tulane.edu/~wyp/software/Exon_CNV.m" target="_blank">Copy number variation (CNV) detection from exome sequencing data using a sparse model</a></h4>
</div>
