...
echo "You will now be redirected to the main Page</b></font></center> <META HTTP-EQUIV = 'Refresh' Content = '3; URL =" . $sitebase ."https://github.com/agisga/grpSLOPEMC'> ";
		}else{
...
<!--top-bottom1 end-->     
  ...
  <a href="grpSLOPE.html" class="list-group-item">grpSLOPE</a>
  <a href="index.php" class="list-group-item list-group-item-info">Download</a>
  <a href="#" class="list-group-item">Documentation</a>
  <a href="http://ieeexplore.ieee.org/document/8166765/" target="_blank" class="list-group-item">Publications</a>
...
<h4 class="text-info"><a href="https://github.com/agisga/grpSLOPEMC" target="_blank">Group sorted L1 penalized estimation (grpSLOPE) for feature selection</a></h4>
</div>
