...
echo "You will now be redirected to the main Page</b></font></center> <META HTTP-EQUIV = 'Refresh' Content = '3; URL =" . $sitebase ."https://sites.google.com/site/xiaobaocao006/database-for-download'> ";
		...
		echo '<font color=#09F><b>Your email is required.</b></font>';
	}
...
<!--top-bottom1 end-->     
  ...
  <a href="(M-FISH) database.html" class="list-group-item">(M-FISH) database</a>
  <a href="index.php" class="list-group-item list-group-item-info">Download</a>
  <a href="#" class="list-group-item">Documentation</a>
  <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3854670/" target="_blank" class="list-group-item">Publications</a>
...
<h4 class="text-info"><a href="https://sites.google.com/site/xiaobaocao006/database-for-download" target="_blank">Multi-color fluorescence in situ image (M-FISH) database</a></h4>
</div>
