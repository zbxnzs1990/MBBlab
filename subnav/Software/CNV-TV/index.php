...
echo "You will now be redirected to the main Page</b></font></center> <META HTTP-EQUIV = 'Refresh' Content = '3; URL =" . $sitebase ."http://www.tulane.edu/~wyp/software/CNV_TV_pub.m'> ";
		}else{
...
<!--top-bottom1 end-->     
  ...
  <a href="CNV-TV.html" class="list-group-item">CNV-TV</a>
  <a href="index.php" class="list-group-item list-group-item-info">Download</a>
  <a href="#" class="list-group-item">Documentation</a>
  <a href="https://bmcbioinformatics.biomedcentral.com/articles/10.1186/1471-2105-14-150" target="_blank" class="list-group-item">Publications</a>
...
<h4 class="text-info"><a href="http://www.tulane.edu/~wyp/software/CNV_TV_pub.m" target="_blank">Copy number variation detection from sequencing data using CNV-TV</a></h4>
</div>
