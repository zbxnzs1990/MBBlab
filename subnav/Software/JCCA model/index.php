...
echo "You will now be redirected to the main Page</b></font></center> <META HTTP-EQUIV = 'Refresh' Content = '3; URL =" . $sitebase ."https://sites.google.com/site/jianfang86/JSCCA'> ";
		}else{
...
<!--top-bottom1 end-->     
  ...
  <a href="JCCA model.html" class="list-group-item">JCCA model</a>
  <a href="index.php" class="list-group-item list-group-item-info">Download</a>
  <a href="#" class="list-group-item">Documentation</a>
  <a href="https://academic.oup.com/bioinformatics/article-lookup/doi/10.1093/bioinformatics/btw485" target="_blank" class="list-group-item">Publications</a>
...
<h4 class="text-info"><a href="https://sites.google.com/site/jianfang86/JSCCA" target="_blank">Joint CCA model for class-specific correlation analysis</a></h4>
</div>
